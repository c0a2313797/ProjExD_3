...
class Score:
    """"""
    def __init__(self):
        self.fonto = pg.font.SysFont("hgpp創英角ﾎﾟｯﾌﾟ体",30)
        self.color = (0,0,255)
        self.score = 0
...
class Explosion:
    def __init__(self,center:tuple[int,int]):
        self.images = [pg.image.load("fig/explosion.gif"),pg.transform.flip(pg.image.load("fig/explosion.gif"),True,True)]
        self.img_idx = 0
            ...
            for j,beam in enumerate(beams):
                if beam is not None: #Noneでないなら
                    if beam.rct.colliderect(bomb.rct): #ビームが爆弾を打ち落としたら
                        ...
                        bird.change_img(6,screen) #打ち落としたら喜ぶ
                        pg.display.update()
